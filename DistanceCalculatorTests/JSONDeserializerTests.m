...
@interface JSONDeserializerTests : XCTestCase
@property(nonatomic) DistanceCalculationClass *distanceCalculationClass;
@end

@implementation JSONDeserializerTests
...
- (void)testSerializerFucntion
{
    NSString *userDetailsContentData = [self.distanceCalculationClass readContentsOfFile];
    NSArray *customerListDataArray = [JSONDeserializer deserializedDataFromCalculationClass:userDetailsContentData];
    XCTAssertNotNil(customerListDataArray);
}
